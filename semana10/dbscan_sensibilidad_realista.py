"""
DBSCAN sensitivity analysis for dataset_sintetico_FIRE_UdeA_realista.
...
DATA_PREP_PATH = BASE_DIR / "datos_preprocesados" / "dataset_sintetico_FIRE_UdeA_realista_preprocesado.csv"
DATA_ORIG_PATH = BASE_DIR / "dataset_sintetico_FIRE_UdeA_realista.csv"
...
def plot_results(
    ...
    ax0 = axes[0]
    s0 = ax0.scatter(x_2d[:, 0], x_2d[:, 1], c=y_true, cmap="Set1", s=28, alpha=0.8)
...
def main() -> None:
    min_samples = 3
    quantiles = [0.40, 0.55, 0.70, 0.80, 0.88, 0.93, 0.97]
    ...
    fig_path = OUT_DIR / "dbscan_sensibilidad_realista.png"
    csv_path = OUT_DIR / "dbscan_sensibilidad_realista_resumen.csv"
    ...
    plot_results(
        ...
        min_samples=min_samples,
        results=results,
        title="DBSCAN sensitivity - UdeA realista",
        out_file=fig_path,
    )
